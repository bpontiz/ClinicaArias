    ...
    return (
        <section className="SectionSpecialities">
            ...
            <div className="DivSpecialities">
                ...
                <p className="SpecialitiesInfo">Es una intervención quirúrgica que se encarga de corregir las deformidades dento-craneo-maxilofaciales mediante movimientos óseos maxilares y mandibulares, para lograr el equilibrio perfecto entre todas las características faciales del paciente.</p>
